...
<script>
  import moment from 'moment'
    const COMPONENT_NAME = 'jx-mobilink-datetime-picker'
...
<style scoped>
  ...
  .vmdtp-overlay { height: 100vh; left: 25px; position: absolute; top: 35px; width: 100vw; z-index: 998;
  ...
  .vmdtp-dialog { background: #fff; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.2); display: block; font-family: 'Roboto'; font-weight: 400; left: 0; max-width: 100%; position: absolute; top: 0; width: 400px; z-index: 999;
  }
  ...
  .vmdtp-datepicker { padding: 0 25px; position: relative;}
