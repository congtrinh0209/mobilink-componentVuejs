...
!function(){
    ...
    function n(n){
        ...
        function a(t){
            var n=this;
            return function(e){
                null!==n.realList&&n["onDrag"+t](e),
                s.call(n,t,e)
            }
        }
        var l=["Start","Add","Remove","Update","End"],
        u=["Choose","Sort","Filter","Clone"],
        c=["Move"].concat(l,u).map(function(t){return"on"+t}),
        d=null,
        f={
            options:Object,
            list:{
                type:Array,required:!1,"default":null
            },
            value:{
                type:Array,required:!1,"default":null
            },
        ...
        h={
            ...
            mounted:function(){
                ...
                this._sortable=new n(this.rootContainer,o),
                this.computeIndexes()
            },
            ...
            methods:{
                getChildrenNodes:function(){
                    if(
                        this.init||
                        (
                            this.noneFunctionalComponentMode=this.noneFunctionalComponentMode&&1==
                            this.$children.length,this.init=!0
                        ),
                ...
                computeIndexes:function(){
                    ...
                    this.$nextTick(
                        function(){
                            t.visibleIndexes=r(t.getChildrenNodes(),
                ...
                getUnderlyingVm:function(t){
                    ...
                    if(n===-1)
                        return null;var e=this.realList[n];
                    return{
                        index:n,element:e
                    }
                },
                ...
                onDragStart:function(t){
                    ...
                    t.item._underlying_vm_=this.clone(this.context.element),d=t.item},
                    onDragAdd:function(t){
                        var n=t.item._underlying_vm_;
                        if(void 0!==n){
                            e(t.item);
                            var o=this.getVmIndex(t.newIndex);
                            this.spliceList(o,0,n),
                            this.computeIndexes();
                    ...
                    onDragRemove:function(t){
                        if(o(this.rootContainer,t.item,t.oldIndex),this.isCloning)
                            return void e(t.clone);
                        var n=this.context.index;
                        this.spliceList(n,1);
                        var i={element:this.context.element,oldIndex:n};
                        this.resetTransitionData(n),
                        this.emitChanges({removed:i})
                    },
                    onDragUpdate:function(t){
                        e(t.item),
                        o(t.from,t.item,t.oldIndex);
                        var n=this.context.index,i=this.getVmIndex(t.newIndex);
                        this.updatePosition(n,i);
                        var r={element:this.context.element,oldIndex:n,newIndex:i};t
                        his.emitChanges({moved:r})
                    },
                    computeFutureIndex:function(t,n){
                        ...
                        o=e.indexOf(n.related),i=t.component.getVmIndex(o),
                        r=e.indexOf(d)!=-1;
                    ...
                    onDragMove:function(t,n){
                        ...
                        return _extends(i,{futureIndex:r}),
        ...
        if(
            ...
            define(["sortablejs"],function(t){
                return n(t)
            });
        else if(window&&window.Vue&&window.Sortable){
            var o=n(window.Sortable);Vue.component("draggable",o)
        }
    }();

    //thieu 1 dau } o cuoi cung